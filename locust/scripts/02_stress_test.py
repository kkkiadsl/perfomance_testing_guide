...
부하 단계:
  0~  60초 :  50명 (기준선 — 안정 구간)
  60~120초 : 100명 (증가 1단계)
  120~180초: 150명 (증가 2단계)
  180~240초: 200명 (증가 3단계)
  240~300초: 250명 (증가 4단계 — 한계 구간 진입, 실측 breaking point)
  300~360초: 300명 (증가 5단계 — 한계 초과)
...
class StressTestShape(LoadTestShape):
    ...
    stages = [
        (60,  50,  10),   # 0~60초   :  50명 (기준선)
        (120, 100, 10),   # 60~120초 : 100명
        (180, 150, 10),   # 120~180초: 150명
        (240, 200, 10),   # 180~240초: 200명
        (300, 250, 10),   # 240~300초: 250명 (한계 구간 진입)
        (360, 300, 10),   # 300~360초: 300명 (한계 초과)
        (420, 0,   20),   # 360~420초: Ramp-down
    ]
